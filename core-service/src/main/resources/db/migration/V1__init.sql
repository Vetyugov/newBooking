...
insert into apartments (title, price)
values ('Milk', 100.20),
       ('Bread', 80.20),
       ('Cheese', 90.20),
       ('Cheese2', 90.00),
...
(
    ...
    price_per_apartment numeric(8, 2)    not null,
    price             numeric(8, 2)    not null,
    created_at        timestamp default current_timestamp,
    updated_at        timestamp default current_timestamp
);
...
insert into order_items (apartment_id, order_id, quantity, price_per_apartment, price)
